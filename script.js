document.addEventListener('DOMContentLoaded', () => {
    ...
    Plotly.d3.csv("PurchasePower.csv", PurchasePower_data => {
        Plotly.d3.csv("BLM Sentiment.csv", function (BLMSentimentCsv) {
        ...
        Plotly.d3.csv("BLM Timeline.csv", BLMTimelineCsv => {
        ...
        Plotly.d3.csv("Cyberbullying ratio.csv", function (CyberbullyingRatioCsv) {
        ...
        Plotly.d3.csv("Profit.csv", ProfitCsv => {
        ...
        Plotly.d3.csv("Brand.csv", BrandCsv => {
        ...
        Plotly.d3.csv("SalesSEK.csv", SalesCsv => {
